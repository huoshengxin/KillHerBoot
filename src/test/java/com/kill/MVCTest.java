...
//                .andExpect(MockMvcResultMatchers.content().json("[{\"id\":6,\"username\":\"shiyanlou\",\"password\":\"password\"}]"))
//                .andDo(print());
//    }
//
//    /**
...
//        )
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andExpect(MockMvcResultMatchers.content().json("{\"id\":6,\"username\":\"shiyanlou\",\"password\":\"shiyanlou\"}"))
//                .andDo(print());
//    }
//
//    /**
